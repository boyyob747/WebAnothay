                    ...
                    <div class="form-group">
                      ...
                      {{ method_field('PUT') }}
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            'placeholder' => 'Trường đại học','aria-describedby' => 'sizing-addon1', 'required','id' => 'khoa'))!!}
                        </div>
                        <br>
                        <div class="text-right">
                          <button id="btn_acction" class="btn btn-primary"  data-dismiss="modal" name="close_form"> Update</button>
